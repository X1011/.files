        ...
        while True:
            try:
                ...
                if 'reason' in e.args[0]:
                  ...
                  self.logfile.write('requests.exceptions.ConnectionError\n')
                  print(e.args)
                  print(e.args[0])
                time.sleep(1)
            except:
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description = 'Retrieve GEDCOM data from FamilySearch Tree (17 Aug 2015)', add_help = False, usage = 'getmyancestors.py -u username -p password [options]')
